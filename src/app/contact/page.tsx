...
const socialPlatforms = [
  ...
  },
  {
    ...
    icon: <FacebookIcon />,
    accounts: [
      { name: "Grant Gould Media", handle: "Grant Gould Media" },
      { name: "Granville Stories", handle: "Granville Stories" },
      { name: "Grant You a Story", handle: "Grant You a Story" },
    ],
  },
];
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full border border-charcoal-800 bg-charcoal-950 px-4 py-3 text-white outline-none transition placeholder:text-white/40 focus:border-burgundy-700"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  className="w-full resize-none border border-charcoal-800 bg-charcoal-950 px-4 py-3 text-white outline-none transition placeholder:text-white/40 focus:border-burgundy-700"
                />
              </div>
              ...
              {socialPlatforms.map((platform) => {
                ...
                return (
                  <div key={platform.key}>
                    <button
                      type="button"
                      className="flex w-full items-center gap-3 border border-charcoal-800 bg-charcoal-950 px-4 py-3 text-left text-white transition hover:border-burgundy-700 hover:text-burgundy-700"
                      onClick={() =>
                    ...
                    <AnimatePresence initial={false}>
                      {isOpen ? (
                        ...
                        >
                          <div className="mt-2 border border-charcoal-800 bg-charcoal-950 p-4">
