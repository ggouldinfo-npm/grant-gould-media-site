      ...
      <section className="relative min-h-[78vh] overflow-hidden">
        ...
        >
          <div className="max-w-4xl">
            ...
            <motion.h1
              variants={riseIn}
              className={`${spaceGrotesk.className} max-w-5xl text-5xl font-semibold leading-[1.12] tracking-normal text-white sm:text-7xl`}
            >
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-8">
                    ...
                    <h2
                      className={`${spaceGrotesk.className} mt-3 text-[1.65rem] font-semibold leading-tight tracking-normal text-white`}
                    >
                      {project.title}
                    </h2>
